...
- Keys: `all` plus any locked mode (`smart`, `smartGPT`, `smartSonnet`, `rush`, `test`, `large`, `deep`). `open`, `free`, and unknown keys are ignored with a warning.
